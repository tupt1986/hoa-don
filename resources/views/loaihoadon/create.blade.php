...
@section('content')
    ...
    <div class="row">
        <div class="col-md-8 col-md-offset-2 col-sm-5 col-sm-offset-1">
            <form class="sky-form" style="border-width: 0px;" action="{{url('/loaihoadon/create')}}" method="post" name="addloaibuugui" id="addloaibuugui" >
                {{csrf_field()}}
                <section>
                    <div class="row">
                        ...
                        <div class="col col-8">
                            <label class="input">
                                <input type="text" name="ten" placeholder="Nhập tên loại hóa đơn (bắt buộc)" value="{{ old('ten') }}">
                            </label>
                        </div>
                    </div>
                </section>
                <section>
                    <div class="row">
                        ...
                        <div class="col col-8">
                            <label class="input">
                                <input type="text" name="mau" placeholder="Ký hiệu mẫu hóa đơn (bắt buộc)"  value="{{ old('mau') }}">
                            </label>
                        </div>
                    </div>
                </section>
                <section>
                    <div class="row">
                        ...
                        <div class="col col-8">
                            <label class="input">
                                <input type="text" name="kyhieu" placeholder="Ký hiệu hóa đơn (bắt buộc)"  value="{{ old('kyhieu') }}">
                            </label>
                        </div>
                    </div>
                </section>
